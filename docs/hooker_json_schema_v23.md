# Hooker Descendants JSON — Master Schema (v23, comprehensive merge)

Version 23.0 — merged comprehensive edition, July 2026
Compiler: Samuel Talcott Hooker

**What this document is.** v23 is the *comprehensive, self-contained* schema: it is the
complete v21 master body with every v22 addendum delta folded into place, so no reader
needs to hold two documents in their head. There is nothing in v21 or the v22 addendum
that is not carried here. Where v22 amended a v21 rule, the amended rule is stated inline
at the point of use AND the v22 sections (§A–§E, §1, §2) are preserved in full at the end
as the authoritative delta record. If an inline note and the appended v22 section ever
appear to differ, the appended v22 section wins — it is the exact decision text.

**Reading order for a new contributor:** §0 (operating discipline) -> §2 (IDs) -> §4/§5
(person template + field rules) -> §6 (tags) -> the v22 blocks §A-§E at the end (the most
recent decisions: amended enums, easter-egg ceiling, videos array, issues register).
Re-read §0 every 3 turns; §5/§6 and the v22 §B every 10 turns.
