...
- `docs/ENRICHED_DESIGN_FABLE_072426.md` -- the design: *what and why* (durable design decisions, the motion-physics doctrine, the deck/sibling/photo-loading doctrines).
- `docs/ENRICHED_CODING_ROADMAP_FABLE_072426.md` -- the sequencing: *what's next* and the risk/phase order.
...
docs/
  ...
  ENRICHED_DESIGN_FABLE_072426.md         <- current frontend design (what/why)
  ENRICHED_CODING_ROADMAP_FABLE_072426.md <- current frontend sequencing (what's next)
